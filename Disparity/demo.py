...
def demo(args):
    ...
    with torch.no_grad():
        ...
        cv2.imwrite('85.png',(flow_up.squeeze().cpu().numpy())*-1)
...
parser.add_argument('-l', '--left_imgs', help="path to all first (left) frames", default='../data_temp/Images/Left Images/L0062.jpeg')
parser.add_argument('-r', '--right_imgs', help="path to all second (right) frames", default='../data_temp/Images/Right Images/R0062.jpeg')
